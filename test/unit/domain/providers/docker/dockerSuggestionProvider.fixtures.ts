...
export default {
  dockerfile: {
    ...
    expected: <PackageDependency[]>[
      new PackageDependency(
        createPackageManifest('image/test1', '1.0.0', 'test/path/dockerfile'),
      ...
      new PackageDependency(
        createPackageManifest('image/test2', '2.0.0', 'test/path/dockerfile'),
        new PackageDescriptor([
      ...
      new PackageDependency(
        createPackageManifest('image/test3', '3.0.0', 'test/path/dockerfile'),
        new PackageDescriptor([
      ...
      new PackageDependency(
        createPackageManifest('image/test4', '4.0.0', 'test/path/dockerfile'),
        new PackageDescriptor([
      ...
      new PackageDependency(
        createPackageManifest('image/test1', '', 'test/path/dockerfile'),
        new PackageDescriptor([
      ...
      new PackageDependency(
        createPackageManifest('image/test2', '', 'test/path/dockerfile'),
        new PackageDescriptor([
      ...
      new PackageDependency(
        createPackageManifest('image/test3', '', 'test/path/dockerfile'),
        new PackageDescriptor([
      ...
      new PackageDependency(
        createPackageManifest('image/test4', '', 'test/path/dockerfile'),
        new PackageDescriptor([
  ...
  compose: {
    ...
    expected: <PackageDependency[]>[
      new PackageDependency(
        createPackageManifest('node', 'alpine-22', 'test/path/compose.yaml'),
        new PackageDescriptor([
      ...
      new PackageDependency(
        createPackageManifest('alpine', '3', 'test/path/compose.yaml'),
        new PackageDescriptor([
      ...
      new PackageDependency(
        createPackageManifest('postrgres', '', 'test/path/compose.yaml'),
        new PackageDescriptor([
      ...
      new PackageDependency(
        createPackageManifest('./dockerfile', './dockerfile', 'test/path/compose.yaml'),
        new PackageDescriptor([
      ...
      new PackageDependency(
        createPackageManifest('./custom.dockerfile', './custom.dockerfile', 'test/path/compose.yaml'),
        new PackageDescriptor([
      ...
      new PackageDependency(
        createPackageManifest('123456', '', 'test/path/compose.yaml'),
        new PackageDescriptor([
      ...
      new PackageDependency(
        createPackageManifest('dotnet/sdk', '7.0', 'test/path/compose.yaml'),
        new PackageDescriptor([
